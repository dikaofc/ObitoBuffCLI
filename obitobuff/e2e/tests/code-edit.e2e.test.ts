/**
 * E2E test that verifies Obitobuff can perform a simple code edit.
 *
 * Starts Obitobuff in tmux, sends a prompt asking it to add a console.log
...
describe.skip('Obitobuff: Code Edit', () => {
  ...
  test(
    ...
    async () => {
      ...
      // Create the file before starting obitobuff so it's in the initial context
      ...
      // Send a prompt asking obitobuff to add a console.log
