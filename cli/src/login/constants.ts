import { OBITOBUFF_WEB_URL_PROD } from '@codebuff/common/constants/hosts'
...
// Obitobuff login flow uses the obitobuff web app instead of codebuff.com
const OBITOBUFF_WEB_URL = IS_DEV
  ? 'http://localhost:3002'
  : (env.NEXT_PUBLIC_OBITOBUFF_APP_URL ?? OBITOBUFF_WEB_URL_PROD)
export const LOGIN_WEBSITE_URL = IS_OBITOBUFF ? OBITOBUFF_WEB_URL : WEBSITE_URL
...
// Obitobuff ASCII Logo
const LOGO_OBITOBUFF = `
 ███████╗██████╗ ███████╗███████╗██████╗ ██╗   ██╗███████╗███████╗
 ██╔════╝██╔══██╗██╔════╝██╔════╝██╔══██╗██║   ██║██╔════╝██╔════╝
 █████╗  ██████╔╝█████╗  █████╗  ██████╔╝██║   ██║█████╗  █████╗
 ██╔══╝  ██╔══██╗██╔══╝  ██╔══╝  ██╔══██╗██║   ██║██╔══╝  ██╔══╝
...
export const LOGO = IS_OBITOBUFF ? LOGO_OBITOBUFF : LOGO_CODEBUFF
export const LOGO_SMALL = IS_OBITOBUFF ? LOGO_SMALL_OBITOBUFF : LOGO_SMALL_CODEBUFF
