...
export const useMessageQueue = (
  ...
  opts: {
    /** External hold on dequeuing (e.g. the obitobuff session ended and new
  ...
  const processNextMessage = useCallback(() => {
    ...
    // External hold: sending is currently pointless (e.g. obitobuff session
   ...
   *  aborted before it did anything (e.g. the obitobuff session ended between
