...
import { LandingHeadingRow } from '../obitobuff-landing-screen'
import { initializeThemeStore } from '../../hooks/use-theme'
import { getObitobuffStreakLine } from '../../utils/obitobuff-streak-line'
    ...
    root.render(
      <box style={{ flexDirection: 'column', alignItems: 'center', maxWidth: contentMaxWidth }}>
        <box style={{ flexDirection: 'column', alignItems: 'flex-start', gap: 0 }}>
          <LandingHeadingRow
            streakLine={getObitobuffStreakLine(streak)}
            marginBottom={1}
          />
        </box>
      </box>,
