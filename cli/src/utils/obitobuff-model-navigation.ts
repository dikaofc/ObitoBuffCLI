export type ObitobuffModelNavigationDirection = 'forward' | 'backward'
...
export function nextObitobuffModelId(params: {
  modelIds: readonly string[]
  focusedId: string
  direction: ObitobuffModelNavigationDirection
}): string | null {
...
export function obitobuffModelNavigationDirectionForKey(key: {
  name?: string
  shift?: boolean
  sequence?: string
  raw?: string
}): ObitobuffModelNavigationDirection | null {
