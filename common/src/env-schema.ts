...
export const clientEnvSchema = z.object({
  ...
  NEXT_PUBLIC_OBITOBUFF_APP_URL: z.url().optional(),
  ...
  /** Human Behavior session-replay write key for Obitobuff Web. Public by
...
export const clientProcessEnv: ClientInput = {
  ...
  NEXT_PUBLIC_OBITOBUFF_APP_URL: process.env.NEXT_PUBLIC_OBITOBUFF_APP_URL,
