 ...
 *
 * Shared because two apps issue these codes — codebuff.com serves the CLI and obitobuff.com serves
 * Obitobuff Desktop — and a drift between them would show up only as one surface timing out sooner
