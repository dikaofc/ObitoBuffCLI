export const OBITOBUFF_GEMINI_THINKER_AGENT_ID = 'thinker-with-files-gemini'

/** Agent id the obitobuff WEB CHAT uses for its gemini-thinker child (see
 *  agents/thinker/thinker-gemini.ts, spawned from agents/base-chat.ts). Distinct
 *  from the CLI's OBITOBUFF_GEMINI_THINKER_AGENT_ID. */
export const OBITOBUFF_CHAT_GEMINI_THINKER_AGENT_ID = 'thinker-gemini'
...
export const OBITOBUFF_GEMINI_PRO_AGENT_IDS: ReadonlySet<string> = new Set([
  OBITOBUFF_GEMINI_THINKER_AGENT_ID,
  OBITOBUFF_CHAT_GEMINI_THINKER_AGENT_ID,
])

export const OBITOBUFF_GEMINI_THINKER_SYSTEM_INSTRUCTION =
...
export const OBITOBUFF_GEMINI_THINKER_INSTRUCTIONS_PROMPT =
