...
export enum AnalyticsEvent {
  ...
  // (web = the obitobuff.com builder, cloud = connected-repo builder projects).
  ...
  // Obitobuff - Creator Attribution
  OBITOBUFF_REFERRER_ATTRIBUTED = 'obitobuff.referrer_attributed',

  // Obitobuff - Referral program server lifecycle (emitted from packages/billing
  // via the server logger → Axiom `event` column).
  OBITOBUFF_REFERRAL_REDEEMED = 'obitobuff.referral.redeemed',
  ...
  OBITOBUFF_REFERRAL_REDEEM_FAILED = 'obitobuff.referral.redeem_failed',
  ...
  OBITOBUFF_REFERRAL_SOCK_SIGNAL = 'obitobuff.referral.sock_signal',
  // Obitobuff - Get Started Page (referral onboarding funnel, in order:
  ...
  // funnel breakdowns.
  OBITOBUFF_GET_STARTED_VIEWED = 'obitobuff.get_started_viewed',
  OBITOBUFF_GET_STARTED_SIGN_IN_CLICKED = 'obitobuff.get_started_sign_in_clicked',
  OBITOBUFF_GET_STARTED_SIGNED_IN = 'obitobuff.get_started_signed_in',
  OBITOBUFF_GET_STARTED_ELIGIBILITY_RESOLVED = 'obitobuff.get_started_eligibility_resolved',
  OBITOBUFF_GET_STARTED_CONNECT_GITHUB_CLICKED = 'obitobuff.get_started_connect_github_clicked',
  OBITOBUFF_GET_STARTED_INSTALL_COMMAND_COPIED = 'obitobuff.get_started_install_command_copied',
  OBITOBUFF_GET_STARTED_WEB_CLICKED = 'obitobuff.get_started_web_clicked',
  // Deprecated (previous get-started design — no longer fired):
  OBITOBUFF_GET_STARTED_HELP_EXPANDED = 'obitobuff.get_started_help_expanded',
  OBITOBUFF_GET_STARTED_EDITOR_CLICKED = 'obitobuff.get_started_editor_clicked',
  ...
  OBITOBUFF_CHAT_TITLE_GENERATED = 'obitobuff.chat_title_generated',

  // Obitobuff - CLI landing page (/cli). Fired when the install command is
  ...
  OBITOBUFF_CLI_INSTALL_COMMAND_COPIED = 'obitobuff.cli_install_command_copied',

  // Obitobuff - Enterprise landing page (/enterprise). Fired when the contact
  ...
  OBITOBUFF_ENTERPRISE_CONTACT_SUBMITTED = 'obitobuff.enterprise_contact_submitted',

  // Obitobuff - Desktop download CTAs (home hero, products row, /desktop).
  ...
  OBITOBUFF_DESKTOP_DOWNLOAD_CLICKED = 'obitobuff.desktop_download_clicked',

  // Obitobuff Web creation gate: the user's idea was screened as something Web
  ...
  // after leaving /web.
  OBITOBUFF_WEB_GATE_REDIRECT_CLICKED = 'obitobuff.web_gate_redirect_clicked',

  // Obitobuff Web first-session onboarding. The details sequence runs in the
  ...
  OBITOBUFF_WEB_ONBOARDING_STEP = 'obitobuff.web_onboarding_step',
  OBITOBUFF_WEB_ONBOARDING_FINISHED = 'obitobuff.web_onboarding_finished',
  ...
  OBITOBUFF_WEB_TOUR_STEP = 'obitobuff.web_tour_step',
  OBITOBUFF_WEB_TOUR_FINISHED = 'obitobuff.web_tour_finished',
  ...
  OBITOBUFF_BOOKMARK_GATE_SHOWN = 'obitobuff.bookmark_gate_shown',
  OBITOBUFF_BOOKMARK_GATE_CONFIRMED = 'obitobuff.bookmark_gate_confirmed',

  // Obitobuff - Cloud landing page (/cloud). Fired when a logged-out visitor
  ...
  OBITOBUFF_CLOUD_CONNECT_REPO_CLICKED = 'obitobuff.cloud_connect_repo_clicked',
  OBITOBUFF_CLOUD_BLANK_PROJECT_CLICKED = 'obitobuff.cloud_blank_project_clicked',

  // Obitobuff - Home Page
  OBITOBUFF_HOME_INSTALL_COMMAND_COPIED = 'obitobuff.home_install_command_copied',
  OBITOBUFF_HOME_GITHUB_CLICKED = 'obitobuff.home_github_clicked',
  OBITOBUFF_HOME_INSTALL_GUIDE_EXPANDED = 'obitobuff.home_install_guide_expanded',
  OBITOBUFF_HOME_FAQ_OPENED = 'obitobuff.home_faq_opened',

  // Obitobuff - Home savings calculator CTA. Fires alongside
  // OBITOBUFF_DESKTOP_DOWNLOAD_CLICKED (location: savings_calculator) but adds
  ...
  OBITOBUFF_HOME_SAVINGS_CTA_CLICKED = 'obitobuff.home_savings_cta_clicked',

  // Obitobuff - acquisition attribution (UTM / ad-click params captured as
  // super-properties; filter by utm_source, reddit_click_id, is_reddit_traffic)
  OBITOBUFF_ATTRIBUTED = 'obitobuff.attributed',
  OBITOBUFF_AFFILIATE_SIGNUP = 'obitobuff.affiliate.signup',
  OBITOBUFF_AFFILIATE_ACTIVATION = 'obitobuff.affiliate.activation',
  // Obitobuff - Reddit ad funnel (filter in PostHog by reddit_click_id / utm_source)
  OBITOBUFF_REDDIT_FUNNEL_CLI_INSTALLED = 'obitobuff.reddit_funnel.cli_installed',
  OBITOBUFF_REDDIT_FUNNEL_LOGIN = 'obitobuff.reddit_funnel.login',
  OBITOBUFF_REDDIT_FUNNEL_SIGN_UP = 'obitobuff.reddit_funnel.sign_up',
  OBITOBUFF_REDDIT_FUNNEL_FIRST_PROMPT = 'obitobuff.reddit_funnel.first_prompt',
  OBITOBUFF_REDDIT_FUNNEL_RETENTION_1D = 'obitobuff.reddit_funnel.retention_1d',
  OBITOBUFF_REDDIT_FUNNEL_RETENTION_7D = 'obitobuff.reddit_funnel.retention_7d',
  OBITOBUFF_REDDIT_FUNNEL_RETENTION_24D = 'obitobuff.reddit_funnel.retention_24d',
  // Legacy surface-specific names retained for historical dashboards.
  OBITOBUFF_REDDIT_FUNNEL_FIRST_PROMPT_CLI = 'obitobuff.reddit_funnel.first_prompt_cli',
  OBITOBUFF_REDDIT_FUNNEL_FIRST_PROMPT_WEB = 'obitobuff.reddit_funnel.first_prompt_web',
  OBITOBUFF_REDDIT_FUNNEL_FIRST_PROMPT_CHAT = 'obitobuff.reddit_funnel.first_prompt_chat',
  OBITOBUFF_REDDIT_FUNNEL_RETENTION_1D_CLI = 'obitobuff.reddit_funnel.retention_1d_cli',
  OBITOBUFF_REDDIT_FUNNEL_RETENTION_7D_CLI = 'obitobuff.reddit_funnel.retention_7d_cli',
  OBITOBUFF_REDDIT_FUNNEL_RETENTION_24D_CLI = 'obitobuff.reddit_funnel.retention_24d_cli',
  OBITOBUFF_REDDIT_FUNNEL_GRAVITY_AD_CLICK = 'obitobuff.reddit_funnel.gravity_ad_click',

  // Obitobuff web /chat ads experiment (server-rendered Gravity ads vs the
  // existing @gravity-ai/react inline slot; bucketed by user id — see
  // obitobuff/web/src/app/chat/_components/ad-experiment.ts). Both events carry
  // `experiment` + `variant` so PostHog can break down exposure and CTR by arm.
  OBITOBUFF_CHAT_ADS_EXPERIMENT_EXPOSED = 'obitobuff.chat_ads.experiment_exposed',
  OBITOBUFF_CHAT_ADS_AD_SHOWN = 'obitobuff.chat_ads.ad_shown',

  // Obitobuff Desktop (Electron app)
  ...
  // `obitobuff-desktop/src/core/features.ts`. A single PostHog insight
